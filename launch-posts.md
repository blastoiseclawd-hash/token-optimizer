...
Example: "HEARTBEAT.md read 15 times → cache it → save $0.27/session"
...
**Example output:**
"HIGH PRIORITY: Tool calls repeated 886 times → cache file reads → save 177k tokens"
